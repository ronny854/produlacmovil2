...
class IngresarEditarTratamiento extends StatefulWidget {
  int tra_id;
  String tra_fecha;
  int ani_id;
  String tra_diagnostico;
  String tra_medicamento;
  String tra_diastratamiento;
  String tra_descripcion;
  List lista_animales;
  //

  IngresarEditarTratamiento(
      this.tra_id,
      this.tra_fecha,
      this.ani_id,
      this.tra_diagnostico,
      this.tra_medicamento,
      this.tra_diastratamiento,
      this.tra_descripcion,
      this.lista_animales);
  @override
  _IngresarEditarTratamientoState createState() =>
      _IngresarEditarTratamientoState();
}
...
class _IngresarEditarTratamientoState extends State<IngresarEditarTratamiento> {
  ...
  void initState() {
    ...
    if (widget.tra_id != 0) {
      diagnostico.text = widget.tra_diagnostico.toString();
  ...
  guardar_datos() async {
    ...
    if ( _selectedDate_a_enviar == "" &&
      ...
      if (widget.tra_id== 0) {
        ...
        dialog(context, "Enviando Datos", false);
        datos = await controller_general.httpgeneral(
            ip_server + "tratamientos/" + widget.tra_id.toString(),
            "PUT",
            body);
        Navigator.pop(context);
      }
