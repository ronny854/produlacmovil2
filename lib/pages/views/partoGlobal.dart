...
class VisualizarPartoGlobal extends StatefulWidget {
  List datos;

  VisualizarPartoGlobal(this.datos);
  @override
  _VisualizarPartoGlobalState createState() => new _VisualizarPartoGlobalState();
}

class _VisualizarPartoGlobalState extends State<VisualizarPartoGlobal> {
              ...
              children: <Widget>[
                ...
                TextField(
                  ...
                  onChanged: (value) {
                    setState(() {
                      lista_datos = widget.datos
                          .where((element) => (element['ani_id_hijo_nombre']
                                  .toLowerCase()
                                  .contains(value.toLowerCase()) ||
                              element["ani_id_madre_nombre"]
                                  .toLowerCase()
                                  .contains(value.toLowerCase()) ||
